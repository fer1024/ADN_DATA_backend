...
export class AuthController {
    ...
    static login = async (req: Request, res: Response) => {
        try {
            ...
            if (!user.confirmed) {
                ...
                return res.status(401).json({ error: 'La cuenta no ha sido confirmada, hemos enviado un e-mail de confirmación' })
            }
    ...
    static requestConfirmationCode = async (req: Request, res: Response) => {
        try {
            ...
            // Eliminar tokens anteriores del usuario para evitar confusión
